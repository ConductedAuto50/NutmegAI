...
{{"Players":["Player1", "Player2", "Player3"],"Team_overall":["Team1", "Team2", "Team3"],"Team_season":["Team1 season", "Team2 season", "Team3 season"],"Competition_season":["Competition1 season", "Competition2 season", "Competition3 season"],"Graph_to_be_drawn":[True/False]}}
...
Output: {{"Players":["Lionel Messi", "Cristiano Ronaldo"],"Team_overall":[],"Team_season":[],"Competition_season":[],"Graph_to_be_drawn":[False]}}
Reason: the data is only available in the player stats page. 

Query "How many goals has Real Madrid scored in La Liga 2024-25?"
Output: {{"Players": [],"Team_overall": ["Real Madrid"],"Team_season": [],"Competition_season": [],"Graph_to_be_drawn":[False]}}
Reason: the data is available in the team overall page. 

Query: "did madrid perform better with or without Mbappe?"
Output: {{"Players": ["Kylian Mbappe"],"Team_overall": ["Real Madrid"],"Team_season": [],"Competition_season": [],"Graph_to_be_drawn":[False]}}
...
Output: {{"Players":[],"Team_overall":[],"Team_season":["Barcelona 2021-22", "Barcelona 2022-23", "Barcelona 2023-24", "Barcelona 2024-25"],"Competition_season":[],"Graph_to_be_drawn":[True]}}
...
Output: {{"Players":[],"Team_overall":[],"Team_season":["Barcelona 2021-22", "Barcelona 2022-23", "Barcelona 2023-24", "Barcelona 2024-25"],"Competition_season":[],"Graph_to_be_drawn":[False]}}
